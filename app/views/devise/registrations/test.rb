<%= form_with model: @user, url: user_registration_path, class: 'registration-main', local: true do |f| %>
  ...
  <div class='form-wrap'>
    ...
    <div class="form-group">
      ...
      <div class='input-name-wrap'>
        <%= f.text_area :last_kana, class:"input-name", id:"last-name-kana", placeholder:"例) ヤマダ" %>
        <%= f.text_area :first_kana, class:"input-name", id:"first-name-kana", placeholder:"例) リクタロウ" %>
      </div>
    </div>
    <div class="form-group">
      <div class='form-text-wrap'>
