class UserPurchase
  ...
  attr_accessor :user_id, :work_id, :postal_code, :municipality, :address, :phone_number, :area_id, :building_name
  ...
  def save
    ...
    Domicile.create(postal_code: postal_code, area_id: area_id, municipality: municipality, address: address,
